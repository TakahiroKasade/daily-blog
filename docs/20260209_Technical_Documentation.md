# Daily Blog Project - Technical Documentation (1-Day MVP)
...
## 6. 未來擴充計畫 (Roadmap)
- [ ] 實作後台管理介面 (Admin Dashboard) 以新增/修改/刪除文章。
- [ ] 增加使用者登入系統 (Spring Security)。
- [ ] 切換至 MySQL/PostgreSQL 資料庫以持久化資料。
- [ ] 部署至雲端平台 (Render/Heroku/AWS)。
